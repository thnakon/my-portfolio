...
const translations = {
    en: {
        ...
        hero: {
            ...
            description: "I'm Thanakon, a developer specialized in building intelligent digital products with AI.",
            cta: "Get in Touch",
    ...
    th: {
        ...
        hero: {
            ...
            description: "ผมธนากร นักพัฒนาผู้เชี่ยวชาญด้านการสร้างสรรค์ผลิตภัณฑ์ดิจิทัลอัจฉริยะด้วย AI",
            cta: "ติดต่อผม",
            scrollDown: "เลื่อนลง",
        },
        ...
        about: {
            ...
            highlight: "ผสานพลังของ Full Stack Integration เข้ากับศักยภาพของ Artificial Intelligence",
            bio: "สวัสดีครับ ผมธนากร ดวงคำวัฒนสิริ นักพัฒนาซอฟต์แวร์ที่ขับเคลื่อนงานด้วย AI (AI-Augmented Developer) ผมไม่ได้มอง AI เป็นแค่เครื่องมือช่วยเขียนโค้ด แต่ใช้ AI เป็นส่วนหนึ่งของกระบวนการคิด ออกแบบ และพัฒนาระบบตั้งแต่ต้นจนจบ\n\nผมเชี่ยวชาญการนำ LLMs และ AI Agents มาประยุกต์ใช้กับระบบงานจริง เพื่อยกระดับซอฟต์แวร์ให้ฉลาดขึ้น คิด วิเคราะห์ และทำงานได้มีประสิทธิภาพมากกว่าเดิม ผ่านเทคโนโลยีอย่าง Laravel และ Next.js ที่ออกแบบด้วยแนวคิดแบบ AI-first\n\nผมเชื่อว่าอนาคตของการพัฒนาซอฟต์แวร์ คือการผสาน AI เข้าเป็นแกนหลักของระบบ เพื่อสร้างเทคโนโลยีที่เติบโตไปพร้อมกับธุรกิจอย่างยั่งยืน",
            age: "อายุ",
            location: "ที่อยู่",
            email: "อีเมล",
